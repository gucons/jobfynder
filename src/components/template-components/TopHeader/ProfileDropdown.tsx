...
const ProfileDropdown = () => {
  ...
  return (
    <Dropdown as="li" className="nav-item ms-2" drop="down" align="end">
      ...
      <DropdownMenu
        className="dropdown-animation dropdown-menu-end small me-md-n3 pt-3"
      ...
      >
        ...
        <li>
          <div className="modeswitch-item theme-icon-active d-flex justify-content-center align-items-center gap-3 p-2 pb-0">
            <span>Mode:</span>
